...
def show_installments_stage():
    ...
    if not start_date_str:
        st.error("⚠️ Start date not found in configuration. Please complete Stage 1 first.")
        return
...
def show_analysis_stage():
    ...
    tab1, tab2, tab3 = st.tabs(["📊 Basic Analysis", "🔄 Scenario Analysis", "📈 Summary & Export"])
    ...
    with tab1:
        ...
        st.info("ℹ️ Switch to the 'Scenario Analysis' tab to run detailed analysis.")
    
    with tab2:
        st.subheader("🔧 Enhanced Analysis Configuration")
        
        # Move the analysis tools from sidebar to this tab
            ...
            with st.expander("⚙️ Advanced Options"):
                ...
                if use_custom_installment:
                    custom_installment = st.number_input(
                        ...
                        help="Custom amount for the winner installment"
                    )
        ...
        analysis_inputs = {
            ...
            'winner_installment_amount': custom_installment
        }
        ...
        if 'analysis_result' in st.session_state and 'enhanced_config' in st.session_state:
            ...
            st.info("📊 Configure the analysis parameters above and click 'Run Enhanced Analysis' to begin.")
    ...
    with tab3:
        if 'analysis_result' in st.session_state and 'enhanced_config' in st.session_state:
            ...
            st.info("📊 No analysis results available. Please run the analysis first in the 'Scenario Analysis' tab.")
...
# Analysis functions are now imported from enhanced_analysis_functions.py
